...
export class Colis {
    constructor(
        private id: string,
        private code_suivi: string,
        private typeProduit: string,
        private poids: number,
        private expediteur: string,
        private destinataire: string,
        private etat: string,
        private cargaisonId?: string
    ) {}

    getId(): string { return this.id; }
    getCodeSuivi(): string { return this.code_suivi; }
    getTypeProduit(): string { return this.typeProduit; }
    getPoidsTotal(): number { return this.poids; }
    getExpediteur(): string { return this.expediteur; }
    getDestinataire(): string { return this.destinataire; }
    getEtat(): string { return this.etat; }
    getCargaison(): string | undefined { return this.cargaisonId; }

    setEtat(etat: string) { this.etat = etat; }
    setCargaison(cargaisonId: string) { this.cargaisonId = cargaisonId; }
